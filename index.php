...
.modal-footer>:not(:last-child) {
    ...
    <!-- slider_area_start -->
    <div class="slider_area" style="background-image: url(images/b1.jpg);">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            ...
                            <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: #57b846; margin-left: -147px; margin-top:-35px;">
                                Transferring Money between multiple accounts
                            </h2>
                            <br>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: white; margin-left: -142px;">
                                Managed by the cashier!
                            </p>
                            <br>
                ...
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s"
                            style="font-size: 50px; color:#57b846; margin-top: -110px;" id="services"> SERVICES</span>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInLeft" data-wow-duration="1.2s"
                            ...
                            <button type="button" data-toggle="modal" data-target="#myModal">
                                <div class="icon">
                                    <img src="img/svg_icon/add.svg" alt="" height="70px" width="70px">
                                </div>
                                <h3>ADD CUSTOMER</h3>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 style="margin-left: 0px;">ADD CUSTOMER</h4>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            ...
                            <button type="button" onclick="window.location.href='/Basic-Banking-System/transact.php'">
                                <div class="icon">
                                    <img src="img/svg_icon/money-transfer.svg" alt="" height="74px" width="74px">
                                </div>
                    ...
                    <div class="col-xl-4 col-md-4" >
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            ...
                            <button type="button" onclick="window.location.href='/Basic-Banking-System/view.php'">
                                <div class="icon">
                                    <img src="img/svg_icon/view-details.svg" alt="" height="74px" width="74px">
                                </div>
